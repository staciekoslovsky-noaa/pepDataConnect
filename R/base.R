...
# base.geo_alaska_dcw --------------------------------------------------------------------------------
#' Get pep "base" data: geo_alaska_dcw
#'
#' @description
#' Return all records from base.geo_alaska_dcw as an sp object
#'
#' @details
#' This function returns all records in the base.geo_alaska_dcw table. This table contains all the spatial footprints for the IR, RGB and UV images
...
#'
#' @return A sp object containing all records in the base.geo_alaska_dcw table.
#' @export
#'
#' @examples
...
#' data <- base.geo_alaska_dcw(con)
#'
#' # When you're done, disconnect from the database
#' pep_disconnect(con)
#'
base.geo_alaska_dcw <- function(con){
  sf::st_read(con, query = "SELECT * FROM base.geo_alaska_dcw")
}
